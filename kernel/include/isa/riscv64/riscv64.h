...
#define FORCE_ENABLE_INTERRUPTS()  csr_set_bits(CSR_REG_SSTATUS,   SUPERVISOR_INTERRUPT_ENABLE_BIT)
#define FORCE_DISABLE_INTERRUPTS() csr_clear_bits(CSR_REG_SSTATUS, SUPERVISOR_INTERRUPT_ENABLE_BIT)
