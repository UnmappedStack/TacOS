...
#define FORCE_DISABLE_INTERRUPTS() __asm__ volatile("cli")
#define FORCE_ENABLE_INTERRUPTS()  __asm__ volatile("sti")

// freezes only this cpu by turning off interrupts then waiting (forever) for an interrupt to occur.
